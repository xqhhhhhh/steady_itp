...
// package/lib/create-entity-finder-api.js
    ...
    "package/lib/create-entity-finder-api.js"(exports, module) {
        ...
        function getDomainFromOriginOrURL(originOrURL) {
            if (typeof originOrURL !== "string")
                return null;
            if (originOrURL.length > 1e4 || originOrURL.startsWith("data:"))
                return null;
            if (DOMAIN_IN_URL_REGEX.test(originOrURL))
                return originOrURL.match(DOMAIN_IN_URL_REGEX)[1];
            if (DOMAIN_CHARACTERS.test(originOrURL))
                return originOrURL.match(DOMAIN_CHARACTERS)[0];
            return null;
        }
...
// package/dist/entities-nostats.json
...
// package/lib/subsets/nostats.js
